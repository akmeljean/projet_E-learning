...
(function () {
  ...
  // The chatbot calls a server-side API route to avoid exposing API keys in the client bundle.
  ...
  function getCSSStyles() {
    return `
      ...
      #tt-chatbot-fab.tt-fab-active {
        background: linear-gradient(135deg, var(--lux-gold, #b8860b), var(--lux-gold-2, #ffd700));
        border-color: rgba(255, 215, 0, 0.55);
        box-shadow: 0 8px 34px rgba(184, 134, 11, 0.55);
      }
      ...
      .tt-chat-window {
        ...
        background: linear-gradient(160deg, rgba(6, 8, 12, 0.92) 0%, rgba(9, 12, 18, 0.94) 60%, rgba(6, 8, 12, 0.96) 100%);
      ...
      .tt-bot-avatar {
        ...
        height: 30px;
        border-radius: 50%;
        background: linear-gradient(135deg, rgba(214, 179, 90, 0.95), rgba(242, 212, 138, 0.8));
        display: flex;
        align-items: center;
        justify-content: center;
        font-size: 0.85rem;
      ...
      /* Light theme support (matches site toggle) */
      body.theme-light .tt-chat-window {
        background: linear-gradient(160deg, rgba(255, 255, 255, 0.92) 0%, rgba(248, 246, 240, 0.94) 60%, rgba(255, 255, 255, 0.96) 100%);
        border-color: rgba(0, 0, 0, 0.10);
      }

      body.theme-light .tt-chat-header {
        border-bottom-color: rgba(0, 0, 0, 0.08);
      }

      body.theme-light .tt-agent-name {
        color: rgba(16, 11, 3, 0.92);
      }

      body.theme-light .tt-agent-status {
        color: rgba(16, 11, 3, 0.62);
      }

      body.theme-light .tt-bot-bubble {
        background: rgba(255, 255, 255, 0.80);
        border-color: rgba(0, 0, 0, 0.10);
        color: rgba(16, 11, 3, 0.92);
      }

      body.theme-light .tt-user-bubble {
        color: rgba(16, 11, 3, 0.92);
      }

      body.theme-light .tt-chat-input-area {
        background: rgba(255, 255, 255, 0.72);
        border-top-color: rgba(0, 0, 0, 0.08);
      }

      body.theme-light .tt-chat-input {
        color: rgba(16, 11, 3, 0.92);
        background: rgba(255, 255, 255, 0.70);
        border-color: rgba(0, 0, 0, 0.10);
      }

      body.theme-light .tt-chat-input::placeholder {
        color: rgba(16, 11, 3, 0.45);
      }
    `;
  }
